    ...
    def parse(self, response):
        ...
        for medicamento in medicamentos:
        	...
        	if nome_medicamento is not None:
                ...
                producer.send('farmacia', dados_medicamento)
        # Se tiver alguma mensagem para ser enviada fica parado neste ponto abaixo de flush até que estas mensagens sejam enviadas.
        producer.flush()
